data_des = {
    ...
    "avoid_disclosing_P_info_online":"What is your opinion of each of the following statements? Select the appropriate response for each: [I think one should avoid disclosing personal information online]", 
    
    "risk_CC_increased":"What is your opinion of each of the following statements? Select the appropriate response for each: [I feel that the risk of becoming a victim of cyber crime has increased in the past year.]",
    
    "myinfo_not_secure_enough":"What is your opinion of each of the following statements? Select the appropriate response for each.: [I am concerned that my online personal information is not secure enough ]",
    
    "protected_against_cyber_crime":"What is your opinion of each of the following statements? Select the appropriate response for each: [I feel that I am well protected against cyber crime]",
    
    "Accept_Internet_surveillance":"What is your opinion of each of the following statements? Select the appropriate response for each: [I am willing to accept increased Internet surveillance from the government if it can enhance Internet security ]",
    
    "law_manage_cyber_crime":"What is your opinion of each of the following statements? Select the appropriate response for each: [I believe that the laws in effect are effective in managing the cyber crime problem]",
    
    "informed_about_threat":"What is your opinion of each of the following statements? Select the appropriate response for each: [I feel informed about the threat of cyber crime]",
    
    "received_phishing_emails":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Received phishing emails (e.g. asking for money, personal information ",
    
    "experienced_identity_theft":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Identity theft (somebody stealing your personal data and impersonating you",
    
    "experienced_malware":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Malware (e.g. virus) infection of a device]",
    
    "being_unable_to_access_online_services":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Being unable to access online services (e.g. banking services)",
    
    "encountering_religious_extremism_material":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Accidentally encountering material that promotes hatred",
    
    "experienced_online_extortion":"There are several activities that constitute cyber crimes. How often have you experienced or been victim of the following situations? Select the appropriate response for each: [Online extortion (a demand for money to avert or stop extortion",
